...
def main():
    # Prueba específica del EXE empaquetado. Si una dependencia importada por
    # app_v40 (por ejemplo google.protobuf) falta, el proceso ni siquiera llega
    # hasta aquí y el build puede detectarlo. Si todo está incluido, sale 0 sin
    # abrir la interfaz.
