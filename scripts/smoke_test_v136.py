...
assert any(f"src\\main_v{v}.py" in build for v in (136, 137, 138, 139, 140, 141, 142))
assert any(v in workflow for v in ("V136", "V137", "V138", "V139", "V140", "V141", "V142", "V142", "V142-IA"))
