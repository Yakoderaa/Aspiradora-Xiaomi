...
class FakeDevice:
    ...
    def set_property_by(self, siid, piid, value):
        ...
        raise AssertionError("Safe Baseline nunca debe escribir propiedades")
...
core = SafeBaselineCore(vacuum, arbiter=arbiter, source="smoke")
raw = core.raw_device
...
assert raw.actions == [((2, 3), None)], raw.actions
assert started and started[0]["start_action"] == (2, 3), started
...
core2 = SafeBaselineCore(vacuum2, arbiter=RobotCommandArbiter(), source="smoke2")
...
print("V153 Safe Baseline smoke OK")
