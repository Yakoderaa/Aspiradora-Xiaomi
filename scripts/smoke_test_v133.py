...
assert any(f"src\\main_v{v}.py" in build for v in (133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145))
assert any(v in workflow for v in ("V133", "V134", "V135", "V136", "V137", "V138", "V139", "V140", "V141", "V142-IA", "V143-IA", "V144-IA", "V145-IA"))
