...
assert any(f"src\\main_v{v}.py" in build for v in (140, 141, 142, 143, 144, 145))
assert any(v in workflow for v in ("V140", "V141", "V142", "V142", "V142-IA", "V143-IA", "V144-IA", "V145-IA"))
