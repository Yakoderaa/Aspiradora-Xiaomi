...
assert any(f"src\\main_v{v}.py" in build for v in (132, 133, 134, 135, 136, 137, 138, 139, 140))
assert any(v in workflow for v in ("V132", "V133", "V134", "V135", "V136", "V137", "V138", "V139", "V140"))
