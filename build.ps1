...
Invoke-PythonChecked "scripts\smoke_test_release_contract.py"
...
Invoke-PythonChecked "scripts\smoke_test_v80.py"
...
Invoke-PythonChecked "scripts\smoke_test_v87.py"
Invoke-PythonChecked "scripts\smoke_test_v88.py"
Invoke-PythonChecked "scripts\smoke_test_v89.py"
Invoke-PythonChecked "scripts\smoke_test_v90.py"
Invoke-PythonChecked "scripts\smoke_test_v91.py"
Invoke-PythonChecked "scripts\smoke_test_v92.py"
Invoke-PythonChecked "scripts\smoke_test_v93.py"
Invoke-PythonChecked "scripts\smoke_test_v94.py"
Invoke-PythonChecked "scripts\smoke_test_v95.py"
Invoke-PythonChecked "scripts\smoke_test_v96.py"
Invoke-PythonChecked "scripts\smoke_test_v97.py"
Invoke-PythonChecked "scripts\smoke_test_v98.py"
...
Invoke-PythonChecked "scripts\smoke_test_v103.py"
Invoke-PythonChecked "scripts\smoke_test_v104.py"
Invoke-PythonChecked "scripts\smoke_test_v105.py"
Invoke-PythonChecked "scripts\smoke_test_v106.py"
Invoke-PythonChecked "scripts\smoke_test_v107.py"
Invoke-PythonChecked "scripts\smoke_test_v108.py"
Invoke-PythonChecked "scripts\smoke_test_v109.py"
Invoke-PythonChecked "scripts\smoke_test_v110.py"
Invoke-PythonChecked "scripts\smoke_test_v111.py"
Invoke-PythonChecked "scripts\smoke_test_v112.py"
Invoke-PythonChecked "scripts\smoke_test_v113.py"
Invoke-PythonChecked "scripts\smoke_test_v114.py"
Invoke-PythonChecked "scripts\smoke_test_v115.py"
Invoke-PythonChecked "scripts\smoke_test_v116.py"
Invoke-PythonChecked "scripts\smoke_test_v117.py"
Invoke-PythonChecked "scripts\smoke_test_v118.py"
Invoke-PythonChecked "scripts\smoke_test_v119.py"
Invoke-PythonChecked "scripts\smoke_test_v120.py"
Invoke-PythonChecked "scripts\smoke_test_v121.py"
Invoke-PythonChecked "scripts\smoke_test_v122.py"
Invoke-PythonChecked "scripts\smoke_test_v123.py"
Invoke-PythonChecked "scripts\smoke_test_v126.py"
Invoke-PythonChecked "scripts\smoke_test_v127.py"
Invoke-PythonChecked "scripts\smoke_test_v128.py"
Invoke-PythonChecked "scripts\smoke_test_v129.py"
Invoke-PythonChecked "scripts\smoke_test_v130.py"
Invoke-PythonChecked "scripts\smoke_test_v131.py"
...
Invoke-PythonChecked "scripts\smoke_test_v136.py"
Invoke-PythonChecked "scripts\smoke_test_v137.py"
Invoke-PythonChecked "scripts\smoke_test_v138.py"
...
Invoke-PythonChecked "scripts\smoke_test_v143.py"
Invoke-PythonChecked "scripts\smoke_test_v144.py"
Invoke-PythonChecked "scripts\smoke_test_v145.py"
Invoke-PythonChecked "scripts\smoke_test_v146.py"
Invoke-PythonChecked "scripts\smoke_test_v147.py"

# Desde V148 en adelante los smoke tests se descubren automáticamente.
# No volver a agregar versiones nuevas a mano a esta lista.
$futureSmokeTests = Get-ChildItem "scripts\smoke_test_v*.py" | Where-Object {
    $_.BaseName -match '^smoke_test_v(\d+)
...
$appProcess.Refresh()
if ($appProcess.HasExited) { throw "La aplicación actual se cerró durante el smoke test de arranque. Código: $($appProcess.ExitCode)" }
...
Write-Host "Instalador generado: $installer"
 -and [int]$Matches[1] -gt 147
} | Sort-Object {
    if ($_.BaseName -match '^smoke_test_v(\d+)
...
"$hash  Aspiradora-Xiaomi-Setup.exe" | Set-Content -Encoding ASCII "$installer.sha256"
Write-Host "Instalador generado: $installer"
) { [int]$Matches[1] } else { 999999 }
}
foreach ($smoke in $futureSmokeTests) {
    Invoke-PythonChecked $smoke.FullName
}
