...
Invoke-PythonChecked "scripts\smoke_test_v124.py"
Invoke-PythonChecked "scripts\smoke_test_v125.py"
...
$appProcess.Refresh()
if ($appProcess.HasExited) { throw "La aplicación v126 se cerró durante el smoke test de arranque. Código: $($appProcess.ExitCode)" }
