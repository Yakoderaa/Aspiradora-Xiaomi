...
# Aplicación principal v30: pose-id histórico + diagnóstico de telemetría.
...
if ($appProcess.HasExited) {
    throw "La aplicación v30 se cerró durante el smoke test de arranque. Código: $($appProcess.ExitCode)"
}
